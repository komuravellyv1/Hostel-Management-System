...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["btnLogin"])) {
        ...
        if ($msg == "true") {
            ...
            if($info[1]=="UG004")
            {
                header('Location: http://globaletut.com/HMS/sdashboard.php');
            }
            elseif($info[1]=="UG003")
            {

                header('Location: http://globaletut.com/HMS/edashboard.php');
            }
            else
            {
                header('Location: http://globaletut.com/HMS/dashboard.php');
            }
